"""One-batch byte transport for Workstream 04 Shoes 1-4. Never edits images, catalog mappings, gameplay, or player state."""
...
REQUEST = ROOT / 'docs/preproduction/catalog-sprint/chat-shoes-recovery-1-4-20260921.json'
REPORT = ROOT / 'docs/preproduction/catalog-sprint/chat-shoes-recovery-1-4-result.json'
ORIGINALS = ROOT / 'docs/preproduction/catalog-sprint/recovered-originals/shoes-1-4-20260921'
EXPECTED_IDS = ['shoes-1', 'shoes-2', 'shoes-3', 'shoes-4']
...
def main() -> None:
    ...
    if [item['id'] for item in request['items']] != EXPECTED_IDS:
        raise ValueError('This importer accepts only Shoes 1-4')
...
if __name__ == '__main__':
    try:
        ...
        print('Shoes 1-4 intake FAILED: ' + str(error), file=sys.stderr)
        raise
