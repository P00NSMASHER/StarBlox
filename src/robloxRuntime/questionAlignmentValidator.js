...
const SKILL_RULES=Object.freeze({
  ...
  'compare-contrast':{domains:['Analyzing literary text'],standards:['CCSS.RL.2.9'],anchors:['compare','contrast','difference','alike','different','both texts']},
  'text-structure':{domains:["Understanding author’s craft"],standards:['CCSS.RI.2.5'],anchors:['organized','first','next','sequence','cause','compare']},
  'synonym-nuance':{domains:['Word knowledge and skills'],standards:['CCSS.L.2.5'],anchors:['replaces','synonym','meaning','word']},
  'multi-sentence-inference':{domains:['Comprehension strategies and constructing meaning'],standards:['CCSS.RL.2.1'],anchors:['infer','clue','sentences','suggest']},
